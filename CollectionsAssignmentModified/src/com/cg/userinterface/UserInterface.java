	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			case 7:
				...
				Comparator<EmpDetails> sortByDepartment = new Comparator<EmpDetails>() {

					

					@Override
					public int compare(EmpDetails ed1, EmpDetails ed2) {
						// TODO Auto-generated method stub
//						return ed1.getDeptId()-ed2.getDeptId();
						if(ed1.getDepartment().getDeptId()<ed2.getDepartment().getDeptId())
							return 1;
						else if(ed1.getDepartment().getDeptId()>ed2.getDepartment().getDeptId())
						return -1;
						else
						return 0;
					}
